            ...
            <div className={props.visible ? styles.boxVisible : styles.boxHidden}>
                ...
                <div className={styles.summaryItem}>
                    ...
                    <div className={styles.distributionBox}>
                        <div className={styles.distributionBoxEntry}><h3>0</h3><div className={styles.distributionBoxBarEntry}><div style={{"width": distSizes[0], "visibility": distSizes[0] != "0%" ? "visible" : "hidden"}}className={(props.overType != 0 && props.undos == 0) ? styles.barActive : styles.barInactive}><div className={styles.barText}>{props.distribution[0]}</div></div></div></div>
                        <div className={styles.distributionBoxEntry}><h3>1</h3><div className={styles.distributionBoxBarEntry}><div style={{"width": distSizes[1], "visibility": distSizes[1] != "0%" ? "visible" : "hidden"}}className={(props.overType != 0 && props.undos == 1) ? styles.barActive : styles.barInactive}><div className={styles.barText}>{props.distribution[1]}</div></div></div></div>
                        <div className={styles.distributionBoxEntry}><h3>2</h3><div className={styles.distributionBoxBarEntry}><div style={{"width": distSizes[2], "visibility": distSizes[2] != "0%" ? "visible" : "hidden"}}className={(props.overType != 0 && props.undos == 2) ? styles.barActive : styles.barInactive}><div className={styles.barText}>{props.distribution[2]}</div></div></div></div>
                        <div className={styles.distributionBoxEntry}><h3>3</h3><div className={styles.distributionBoxBarEntry}><div style={{"width": distSizes[3], "visibility": distSizes[3] != "0%" ? "visible" : "hidden"}}className={(props.overType != 0 && props.undos == 3) ? styles.barActive : styles.barInactive}><div className={styles.barText}>{props.distribution[3]}</div></div></div></div>
                        <div className={styles.distributionBoxEntry}><h3>4</h3><div className={styles.distributionBoxBarEntry}><div style={{"width": distSizes[4], "visibility": distSizes[4] != "0%" ? "visible" : "hidden"}}className={(props.overType != 0 && props.undos == 4) ? styles.barActive : styles.barInactive}><div className={styles.barText}>{props.distribution[4]}</div></div></div></div>
                        <div className={styles.distributionBoxEntry}><h3>5</h3><div className={styles.distributionBoxBarEntry}><div style={{"width": distSizes[5], "visibility": distSizes[5] != "0%" ? "visible" : "hidden"}}className={(props.overType != 0 && props.undos == 5) ? styles.barActive : styles.barInactive}><div className={styles.barText}>{props.distribution[5]}</div></div></div></div>
